...
st.markdown(
    ...
    .element-container:has(.mobile-bottom-nav-anchor) + [data-testid="stHorizontalBlock"] {
    ...
    .element-container:has(.mobile-bottom-nav-anchor) + [data-testid="stHorizontalBlock"] .stButton button {
    ...
    .mobile-bottom-nav-anchor + [data-testid="stHorizontalBlock"] .stButton button[kind="primary"],
    .element-container:has(.mobile-bottom-nav-anchor) + [data-testid="stHorizontalBlock"] .stButton button[kind="primary"] { background: #c8f7e8; color: #087a6e; font-weight: 700; }
    .mobile-bottom-nav-anchor + [data-testid="stHorizontalBlock"] .stButton button:hover,
    .element-container:has(.mobile-bottom-nav-anchor) + [data-testid="stHorizontalBlock"] .stButton button:hover { color: #087a6e; background: #e7faf3; }
